...
public class MySessionBuilder {
	...
	private MySessionBuilder() {}

	// The SessionManager implements the singleton pattern
	private static volatile MySessionBuilder sInstance = null;

	/**
	 * Returns a reference to the {@link MySessionBuilder}.
	 * @return The reference to the {@link MySessionBuilder}
	 */
	public final static MySessionBuilder getInstance() {
		if (sInstance == null) {
			synchronized (MySessionBuilder.class) {
				if (sInstance == null) {
					MySessionBuilder.sInstance = new MySessionBuilder();
				}
			}
		}
		return sInstance;
	 ...
	 **/
	public MySessionBuilder setContext(Context context) {
		mContext = context;
		return this;
	}

	/** Sets the destination of the session. */
	public MySessionBuilder setDestination(String destination) {
		mDestination = destination;
		return this;
	}

	/** Sets the origin of the session. It appears in the SDP of the session. */
	public MySessionBuilder setOrigin(String origin) {
		mOrigin = origin;
		return this;
	}

	/** Sets the video stream quality. */
	public MySessionBuilder setVideoQuality(VideoQuality quality) {
		mVideoQuality = quality.clone();
		return this;
	}

	/** Sets the audio encoder. */
	public MySessionBuilder setAudioEncoder(int encoder) {
		mAudioEncoder = encoder;
		return this;
	}

	/** Sets the audio quality. */
	public MySessionBuilder setAudioQuality(AudioQuality quality) {
		mAudioQuality = quality.clone();
		return this;
	}

	/** Sets the default video encoder. */
	public MySessionBuilder setVideoEncoder(int encoder) {
		mVideoEncoder = encoder;
		return this;
	}

	public MySessionBuilder setFlashEnabled(boolean enabled) {
		mFlash = enabled;
		return this;
	}

	public MySessionBuilder setCamera(int camera) {
		mCamera = camera;
		return this;
	}

	public MySessionBuilder setTimeToLive(int ttl) {
		mTimeToLive = ttl;
		return this;
	}
	 ...
	 **/
	public MySessionBuilder setSurfaceView(SurfaceView surfaceView) {
	 ...
	 */
	public MySessionBuilder setPreviewOrientation(int orientation) {
		mOrientation = orientation;
		return this;
	}

	public MySessionBuilder setCallback(Session.Callback callback) {
		mCallback = callback;
		return this;
	}
	...
	/** Returns a new {@link MySessionBuilder} with the same configuration. */
	public MySessionBuilder clone() {
		return new MySessionBuilder()
